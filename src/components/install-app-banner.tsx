      ...
      <CardContent className="flex items-start gap-3 text-sm">
        {isIos ? (
          <>
            ...
            <p className="flex-1">
              Установите игру на экран «Домой»: нажмите «Поделиться» → «На экран Домой» — так приложение будет
              открываться быстрее и сможет присылать уведомления.
            </p>
          </>
        ) : (
          <>
            ...
            <div className="flex-1 space-y-2">
              <p>Установите игру на экран — быстрый доступ и уведомления от ведущего.</p>
