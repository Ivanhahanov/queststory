      ...
      <CardContent className="space-y-3">
        <div className="flex items-center gap-3">
          <div className="relative shrink-0">
            <div
              className="flex size-14 items-center justify-center overflow-hidden rounded-xl border-2 bg-muted"
        ...
        {applicableGoals.length > 0 && (
          <div className="space-y-1">
            ...
            <Progress value={(completedCount / applicableGoals.length) * 100} />
          </div>
        )}
